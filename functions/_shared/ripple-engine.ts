 ...
 *
 * NOTE: Diese Datei ist die kanonische Quelle. Wenn geändert,
 * MUSS auch src/lib/ripple-engine.ts synchronisiert werden.
 *
...
export interface RippleAct extends TemporalContainer {}
