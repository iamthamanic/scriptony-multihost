/**
 * Ripple core: calculateRipple (clip endSec change cascade).
 *
 * Repository twin (byte-identical): functions/_shared/ripple-engine-calculate.ts ↔ src/lib/ripple-engine-calculate.ts
