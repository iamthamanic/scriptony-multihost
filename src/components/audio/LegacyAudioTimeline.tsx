/**
 * Legacy Track-basierte Audio-Timeline (pre–audio-clip system).
 */
...
export interface LegacyAudioTimelineProps {
  projectId: string;
  projectType?: string;
}
...
export function LegacyAudioTimeline({
  projectId,
  projectType,
}: LegacyAudioTimelineProps) {
